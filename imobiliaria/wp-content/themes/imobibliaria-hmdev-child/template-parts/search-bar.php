...
?>
    <div id="busca">
        ...
        <input type="hidden" name="s" id="search" value="<?php the_search_query(); ?>" />
            <div class="container p-3" id="ctn-busca">
                    ...
                    <div class="col-4 d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            <div class="d-flex">
                                ...
                                <input name="menorValor" class="me-1" type="range" id="valorMin" min="<?php echo min($valores);?>" max="<?php echo max($valores)-1;?>" onchange="atualizaValorMinMax()">
                                <div id="resultadoMin"><?php echo min($valores);?></div>
                            </div>
                            <div class="d-flex">
                                ...
                                <div id="resultadoMax"><?php echo max($valores);?></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
